 ...
 * </p>
 */
public interface InyeccionDatosPort {
     ...
     * @throws InyeccionDatosException si el formato no es soportado o la inyección falla.
     */
    ...
    /**
     * Excepción específica para errores de inyección de datos.
     */
    class InyeccionDatosException extends RuntimeException {
        public InyeccionDatosException(String mensaje) {
            super(mensaje);
        }
        public InyeccionDatosException(String mensaje, Throwable causa) {
            super(mensaje, causa);
        }
    }
}
